...
L = 0.117        # Расстояние между колёсами в метрах   # Кастомное явление, необходимо измерить и вставить полученное значение
r = 0.065        # Радиус колеса в метрах               # Кастомное явление, необходимо измерить и вставить полученное значение
